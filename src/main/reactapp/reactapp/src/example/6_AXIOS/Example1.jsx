...
// C:\Users\TJ-BU-702-P21\IdeaProjects\tj2024b_web2\src\main\reactapp\reactapp>npm i axios
...
export default function Example1(props){
    ...
    const onEvent3 = async () => {
        ...
        console.log('==================[2 GET]==================')
        const response2 = await axios.get('https://jsonplaceholder.typicode.com/posts/1') // 매개변수 보내기 : path variable 방식
        console.log(response2.data)
        console.log('==================[3 GET]==================')
        const response3 = await axios.get('https://jsonplaceholder.typicode.com/comments?postId=1') // 매개변수 보내기 : queryString 방식
    ...
    const onEvent5 = async() => {
        const obj = {id: 1, title: 'foo', body: 'bar', userId: 1} // 임의 데이터
        const response1 = await axios.put('https://jsonplaceholder.typicode.com/posts/1', obj)
        console.log(response1.data)
    }
    // [6] axios delete test
    const onEvent6 = async() => {
        const response1 = await axios.delete('https://jsonplaceholder.typicode.com/posts/1') // path variable 방식
        console.log(response1.data)
    }
    return (<>
